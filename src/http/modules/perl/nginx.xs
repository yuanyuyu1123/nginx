...
static ngx_int_t
ngx_http_perl_sv2str(pTHX_ ngx_http_request_t
...
->key.data, (u_char *) "Content-Length",
...
&&
ngx_strncasecmp(header
->key.data, (u_char *) "Content-Encoding",
...
ctx->
variables = ngx_array_create(r->pool, 1,
