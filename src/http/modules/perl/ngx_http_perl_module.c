...
*r,
ngx_http_perl_ctx_t *ctx, HV
*nginx,
SV *sub, SV
**args,
ngx_str_t *handler, ngx_str_t
*rv);
...
static void
ngx_http_perl_eval_anon_sub(pTHX_ ngx_str_t
