...
typedef struct {
    ...
    则把这部分内存临时存起来,然后拷贝到下一个4096内存的头部,参考ngx_conf_read_token*/
    ngx_buf_t *dump;
...
str_value是相似的.参见表4-5中Nginx已经实现好的10个简单的配置项合并宏,它们的
参数类型与ngx_conf_merge_str_value一致,而且除了ngx_conf_merge_bufs_value外,它们
都将接收3个参数,分别表示父配置块参数、子配置块参数、默认值.
Nginx预设的10种配置项合并宏:
┏━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃    配置项合并塞          ┃    意义                                                                  ┃
┣━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                          ┃  合并可以使用等号(=)直接赋值的变量,并且该变量在create_loc_conf等分      ┃
┃ngx_conf_merge_value      ┃配方法中初始化为NGX_CONF_UNSET,这样类型的成员可以使用ngx_conf_           ┃
┃                          ┃merge_value合并宏                                                         ┃
┣━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                          ┃  合并指针类型的变量,并且该变量在create_loc_conf等分配方法中初始化为     ┃
┃ngx_conf_merge_ptr_value  ┃NGX_CONF_UNSET_PTR,这样类型的成员可以使用ngx_conf_merge_ptr_value        ┃
┃                          ┃合并宏                                                                    ┃
┣━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                          ┃  合并整数类型的变量,并且该变量在create_loc_conf等分配方法中初始化为     ┃
┃ngx_conf_merge_uint_value ┃NGX_CONF_UNSET_UINT,这样类型的成员可以使用ngx_conf_merge_uint_           ┃
┃                          ┃ value合并宏                                                              ┃
┣━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                          ┃  合并表示毫秒的ngx_msec_t类型的变量,并且该变量在create_loc_conf等分     ┃
┃ngx_conf_merge_msec_value ┃配方法中初始化为NGX CONF UNSET MSEC,这样类型的成员可以使用ngx_           ┃
┃                          ┃conf_merge_msec_value合并宏                                               ┃
┣━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                          ┃  合并表示秒的timej类型的变量,并且该变量在create_loc_conf等分配方法中    ┃
┃ngx_conf_merge_sec_value  ┃初始化为NGX_CONF_UNSET,这样类型的成员可以使用ngx_conf_merge_sec_         ┃
┃                          ┃value合并宏                                                               ┃
┣━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                          ┃  合并size_t等表示空间长度的变量,并且该变量在create_loc_conf等分配方   ┃
┃ngx_conf_merge_size_value ┃法中初始化为NGX.CONF UNSET SIZE,这样类型的成员可以使用ngx_conf_         ┃
┃                          ┃merge_size_value合并宏                                                    ┃
┣━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                          ┃  合并off等表示偏移量的变量,并且该变最在create_loc_conf等分配方法中      ┃
┃ngx_conf_merge_off_value  ┃初始化为NGX_CONF_UNSET．这样类型的成员可以使用ngx_conf_merge_off_         ┃
┃                          ┃value合并宏                                                               ┃
┣━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                          ┃  ngx_str_t类型的成员可以使用ngx_conf_merge_str_value合并,这时传入的     ┃
┃ngx_conf_merge_str_value  ┃                                                                          ┃
┃                          ┃default参数必须是一个char字符串                                         ┃
┣━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                          ┃  ngx_bufs t类型的成员可以使用ngx_conf_merge_str_value舍并宏,这时传入的  ┃
